...
public class AutoBlueFinal extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        imu.resetYaw();
        //set turret and intake to start from beginning
        ...
        //set transfer to run after 1 sec and for atleast 4 sec
        //shooting balls happen here
        runtime.reset();
        ...
        //collection of balls done and go back
